...
def eval(args):
    ...
    model = CMR()
    ie, te = model.build_rvs_model(image_embeddings,text_embeddings, args, is_training = True)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--checkpoint', type=str, default='/home/sxg8458/rvs_three_modalities/exp/model.ckptTensor("add_4:0", shape=(), dtype=int64)', help="checkpoint")
